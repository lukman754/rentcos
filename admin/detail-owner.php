...
<body>
    <div class="container">
        ...
        <main class="w-100 px-md-4">
            ...
            <h2 class="h3 mb-4 mt-4 page-title">Detail Owner</h2>
            <?php include "../owner/detail-profile.php"; ?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="add_costume" class="btn btn-primary">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
